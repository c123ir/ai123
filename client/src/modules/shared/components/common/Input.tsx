...
// برای سازگاری با تایپ‌های Material UI و Ant Design
...
// تبدیل variant های Material UI به Ant Design
const getAntVariant = (variant?: InputVariant): "outlined" | "borderless" | "filled" | "underlined" | undefined => {
  if (variant === 'standard') return 'underlined';
  return variant;
};
...
const Input: React.FC<InputProps> & {
  ...
  // تبدیل variant به نوع Ant Design
  const antVariant = getAntVariant(variant);
